...
public class BibliothequeMVC {
	public BibliothequeMVC() {
		...
		BibliothequeController bibliControllerGUI = new BibliothequeController(bibli);
		BibliothequeVueGUI bibliVueGUI = new BibliothequeVueGUI(bibli, bibliControllerGUI, 100, 100);
		bibliControllerGUI.addView(bibliVueGUI);
		
		
		BibliothequeController bibliControllerConsole = new BibliothequeController(bibli);
		BibliothequeVueConsole bibliVueConsole = new BibliothequeVueConsole(bibli, bibliControllerConsole);
		bibliControllerConsole.addView(bibliVueConsole);
